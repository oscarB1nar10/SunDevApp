...
class RecyclerComicDetailAdapter constructor(private val view: ComicBook) :
    RecyclerView.Adapter<RecyclerComicDetailAdapter.ViewHolder>() {
    //vars
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txvComicPublicationDate.text = comicsDetail[position].date_last_updated
        Picasso.get()
